...
const StarwarsGroundLayer = React.memo(props => {
  ...
  return (
    <SceneObject {...props} name="Starwars Ground Layer">
      ...
      <BrowserView>
        <Brief font={{color: "white"}} content={{ h1: 'Buy tax - 5%', h2: '3% Marketing, 2% development' }} transform={{ position: { x: 100, y: 250 } }} />
        <Brief font={{color: "white"}} content={{ h1: 'Sell tax - 5%', h2: '3% Marketing, 2% development' }} transform={{ position: { x: 1800, y: 259 } }} />
        <Brief font={{color: "white"}} content={{ h1: 'Token details', h2: 'Supply: 1,000,000. Token decimals: 9' }} transform={{ position: { x: 4500, y: 250 } }} />
      </BrowserView>
      <MobileView>
        <Brief font={{color: "white"}} content={{ h1: 'Buy tax - 5%', h2: '3% Marketing, 2% development' }} transform={{ position: { x: 100, y: 1000 } }} />
        <Brief font={{color: "white"}} content={{ h1: 'Sell tax - 5%', h2: '3% Marketing,  2% development' }} transform={{ position: { x: 1800, y: 1000 } }} />
        <Brief font={{color: "white"}} content={{ h1: 'Token details', h2: 'Supply: 1,000,000. Token decimals: 9' }} transform={{ position: { x: 4500, y: 1000 } }} />
      </MobileView>
      <SceneObject
        name="VADER VOLCANO"
        color="orange"
